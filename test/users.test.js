...
describe('2 - Crie um endpoint para o login de usuários', () => {
  ...
  skip.it('Será validado que o campo "email" é obrigatório', async () => {
    await frisby
      .post(`${url}/login/`,
        {
          password: '12345678',
  ...
  skip.it('Será validado que o campo "password" é obrigatório', async () => {
    await frisby
      .post(`${url}/login/`,
        {
          email: 'erickjaquin@gmail.com',
  ...
  skip.it('Será validado que não é possível fazer login com um email inválido', async () => {
    await frisby
      .post(`${url}/login`,
        {
  ...
  skip.it('Será validado que não é possível fazer login com uma senha inválida', async () => {
    await frisby
      .post(`${url}/login`,
        {
  ...
  skip.it('Será validado que é possível fazer login com sucesso', async () => {
    await frisby
      .post(`${url}/users/`,
        {
          name: 'Erick Jacquin',
