...
describe('6 - Crie uma query em mongo que insira uma pessoa usuária com permissões de admin', () => {
  ...
  skip.it('Será validado que o projeto tem um arquivo de seed, com um comando para inserir um usuário root e verifico se consigo fazer login', async () => {
...
describe('12 - Crie um endpoint para cadastro de pessoas administradoras', () => {
  ...
  skip.it('Será validado que não é possível cadastrar um usuário admin, sem estar autenticado como um usuário admin', async () => {
    let result;
  ...
  skip.it('Será validado que é possível cadastrar um usuário admin', async () => {
    let result;
